...
if [ -f "/workspace/venv/bin/activate" ]; then
    ...
    echo "1. Ensure that you have followed the instructions at: https://github.com/wikiboris/runpod-worker-photomaker/blob/main/docs/building/with-network-volume.md"
